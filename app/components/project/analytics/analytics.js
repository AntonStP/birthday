...
class Analytics extends Plugin {
  ...
  constructor($element) {
    ...
    setTimeout( ()=>{this._init();}, 500+_delay );
    // console.log(_delay);
    _delay+=20;
  }
  ...
  _init(){
    ...
    function _send( target, params, platform ){
      ...
      switch(target){
        ...
        //   else console.warn('DSP code is not cinstalled');
        //   break;
        ...
        // case 'mts':
        //   if( window.events ) window.events.push({client_id: params[0], event_type: params[1], start: (new Date()).getTime()});
        //   else console.warn('MTS code is not installed');
        //   break;
